...
def main():
    ...
    tenant_id="03b48d09-39ba-45ff-9d4d-3f1b96702518",
    app_id="f7ec5e18-0076-405f-8cdf-c422514456db",
    secret="v~C8Q~ST4AjULXqNAtdzsU9wWOjrYybV6chsdbiI",
    sub_id="20398138-8224-491d-b84b-abea0678d7ee",
    rg_name="linux-rg",
    nsg_name="rhel-dev-nsg",
    rule_name="AllowAnySSHInbound",
)
